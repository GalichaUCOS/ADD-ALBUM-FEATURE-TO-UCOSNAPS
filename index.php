...
<body>
    ...
    <div class="upload-section">
        <h2 class="section-title">Upload New Photo</h2>
        <form action="handleForms.php" method="POST" enctype="multipart/form-data" class="photo-upload-form">
            <label for="photoDescription">Description</label>
            <input type="text" name="photoDescription" id="photoDescription" placeholder="Enter a description..." required>

            <label for="image">Photo Upload</label>
            <input type="file" name="image" id="image" required>

            <input type="submit" name="insertPhotoBtn" value="Upload Photo" class="submit-btn">
        </form>
    </div>

    <!-- Display Photos Section -->
    <div class="photos-gallery">
        <h2 class="section-title">Imahe</h2>
